...
| Limitation                        | Impact                                                                                                                                                                        |
| --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Managed Kubernetes**            | All three major managed platforms are supported: AKS via Azure Event Hub, EKS via CloudWatch Logs, GKE via Cloud Pub/Sub. See [Cloud Ingestion](concepts/cloud-ingestion.md). |
