...
Complete field reference for the AudiciaReport Custom Resource Definition.
...
A trimmed AudiciaReport as generated by the operator:
...
For the suggested RBAC manifests, see the companion
[AudiciaPolicy CRD](crd-audiciapolicy.md).
