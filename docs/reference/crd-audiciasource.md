...
`as`, `asrc` **kubectl columns:** Source Type, Scope Mode, Age
...
For more examples, see the [Examples](../examples/audicia-source-hardened.md)
section.
...
Configuration for cloud-based audit log ingestion. Used with
