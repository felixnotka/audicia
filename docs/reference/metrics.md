...
Audicia exposes Prometheus metrics on its `/metrics` endpoint (default `:8080`). These metrics provide visibility
into the operator's processing pipeline, report generation, and health.
